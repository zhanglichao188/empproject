	...
	<body style="background-color:#f2f9fd;">
		<div class="header bg-main">
			...
			<div class="logo margin-big-right fadein-top" style="margin-left: 650px;">
				<h4>欢迎，<span style="font-family: 幼圆;color: #0000FF;font-size: 20px;font-weight: bold;">${atm.atmName}</span></h4>
			</div>
		</div>
		<div class="leftnav">
			...
			<ul style="display:block">
				<li><a href="${pageContext.request.contextPath}/emp.action?flag=findAllEmp" target="right"><span class="icon-magic"></span>员工管理</a></li>
		...
		<div class="admin">
			<iframe scrolling="auto" rameborder="0" src="${pageContext.request.contextPath}/page/main/backIndex.jsp" name="right" width="100%" height="100%"></iframe>
		</div>
	</body>
</html>
